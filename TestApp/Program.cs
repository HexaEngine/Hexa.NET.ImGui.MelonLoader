...
builder
    .AddFontFromFileTTF("fonts/arialuni.ttf", 16, [0x1, 0x1FFFF])
    .SetOption(config =>
    {
    ...
    .AddFontFromFileTTF("fonts/MaterialSymbolsRounded.ttf", 16.0f, [0xe003, 0xF8FF])
    .Build();
